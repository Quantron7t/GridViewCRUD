        ...
        <div class="container">
            ...
            <asp:GridView CssClass="table table-striped" runat="server" HeaderStyle-BackColor="#0066cc" ID="CarGridView" OnSelectedIndexChanging="CarGridView_SelectedIndexChanging" DataKeyNames="id" OnRowDataBound="CarGridView_RowDataBound" OnRowDeleting="CarGridView_RowDeleting" OnRowCommand="CarGridView_RowCommand" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Available" HeaderStyle-Width="63">
                        <ItemTemplate>
                            <asp:CheckBox runat="server" ID="CheckBox" Checked='<%# Eval("availability") %>' AutoPostBack="true" OnCheckedChanged="CheckBox_CheckedChanged" />
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h3><small>
                            <asp:Label ID="carNameLabel" runat="server"></asp:Label></small></h3>
                        <asp:Image runat="server" CssClass="img-valign" Height="20" Width="20" ID="selectAvailabilityImage" />
                    ...
                    <div class="modal-body">
                        <dl>
                            <dt>Class</dt>
                            <dd>-
                                <asp:Label runat="server" ID="carTypeLabel"></asp:Label></dd>
                            <dt>In Stock</dt>
                            <dd>-
                                <asp:Label runat="server" ID="carInStockLabel"></asp:Label></dd>
                            <dt>Cost</dt>
                            <dd>-
                                <asp:Label ID="carPriceLabel" runat="server"></asp:Label></dd>
                            <dt>Country of Origin</dt>
                            <dd>-
                                <asp:Label runat="server" ID="carCountryLabel"></asp:Label></dd>
                        </dl>
                    </div>
        ...
        <div id="editCarModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="bg-info"><em>&nbsp;You are editing : <b>
                            <asp:Label runat="server" ID="updateCarNameLabel"></asp:Label></b></em></p>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon" style="width: 108px"><b>In Stock</b></span>
                            <asp:TextBox runat="server" ID="updateInStockTextBox" CssClass="form-control" AutoComplete="false" placeholder="Country of Origin"></asp:TextBox>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="checkbox">
                            <label>
                                <asp:CheckBox runat="server" ID="addCarAvailableCheckBox"></asp:CheckBox>
                                <b> Is Available</b>
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" CssClass="form-control" ID="addCarInStockTextBox"></asp:TextBox>
                        </div>
                    </div>
